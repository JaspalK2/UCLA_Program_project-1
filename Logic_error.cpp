...
int main()
{
    ...
    double winPercentage = 100.0 / won / (won + lost + tied); // right here I changed the multiply sign to a division sign which would cause the file to compile and run correcly, however it will not result in the right answer.
